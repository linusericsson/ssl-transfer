...
def train(segmentation_module, iterator, optimizers, history, epoch, args):
    ...
    batches_in_one_epoch = len(iterator)
    batches_left = (args.num_epoch - epoch + 1) * batches_in_one_epoch
...
def checkpoint(nets, history, args, epoch_num):
    ...
    suffix_latest = 'latest.pth'#'epoch_{}.pth'.format(epoch_num)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--random_flip', default=1, type=int,
    ...
    args.random_flip = (args.random_flip > 0)
